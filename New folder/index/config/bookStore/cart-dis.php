...
$query=mysqli_query($db,"SELECT * FROM products WHERE product_discount='1' ORDER BY id DESC LIMIT 4");
           ...
           <ul id="ul">
            <?php while($row=mysqli_fetch_array($get_cart_items)){
             ...
             <li><?php echo $product_name['product_name']?></li>
              ...
              <li>ريال<?php echo $product_name['product_price']*0.5;?></li>
